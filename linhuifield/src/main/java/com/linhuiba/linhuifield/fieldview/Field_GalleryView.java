...
public class Field_GalleryView extends Gallery
{
	...
	public Field_GalleryView(Context context)
	{
		super(context);
		this.setStaticTransformationsEnabled(true);
	}

	public Field_GalleryView(Context context, AttributeSet attrs)
	{
		super(context, attrs);
		this.setStaticTransformationsEnabled(true);
	}

	public Field_GalleryView(Context context, AttributeSet attrs, int defStyle)
	{
	...
	private void transformImageBitmap(ImageView child, Transformation trans, int rotationAngle)
	{
		...
		// As the angle of the fieldview gets less, zoom in
