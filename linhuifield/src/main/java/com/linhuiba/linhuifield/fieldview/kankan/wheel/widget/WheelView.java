...
package com.linhuiba.linhuifield.fieldview.kankan.wheel.widget;
...
import com.linhuiba.linhuifield.fieldview.kankan.wheel.widget.adapters.WheelViewAdapter;

import java.util.LinkedList;
import java.util.List;

/**
 * Numeric wheel fieldview.
 * 
...
public class WheelView extends View {
	 ...
	 * To apply changes and rebuild fieldview call measure().
	 * 
	...
	/**
	 * Gets fieldview fieldadapter
	 * @return the fieldview fieldadapter
	 */
	...
	/**
	 * Sets fieldview fieldadapter. Usually new adapters contain different views, so
	 * it needs to rebuild fieldview by calling measure().
	 * 
	 * @param viewAdapter the fieldview fieldadapter
	 */
	...
	/**
	 * Updates fieldview. Rebuilds items and label if necessary, recalculate items sizes.
	 */
	...
	/**
	 * Builds fieldview for measuring
	 */
	...
	/**
	 * Adds fieldview for item to items layout
	 * @param index the item index
	 * @param first the flag indicates if fieldview should be first
	...
	/**
	 * Returns fieldview for specified item
	 * @param index the item index
	 * @return item fieldview or empty fieldview if index is out of bounds
	 */
