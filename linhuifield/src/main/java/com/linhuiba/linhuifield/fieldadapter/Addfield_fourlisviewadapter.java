 ...
 */
public class Addfield_fourlisviewadapter extends BaseAdapter {
    ...
    public Addfield_fourlisviewadapter(Context context, Field_AddField_FieldPricesActivity activity, ArrayList<HashMap<String, String>> datas, int invoicetype) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = mInflater.inflate(R.layout.field_activity_field_addfield_fieldprice_item, null);
            holder.maddfield_denominated_fieldsizelayout = (LinearLayout) convertView.findViewById(R.id.addfield_denominated_fieldsizelayout);
            holder.mdenominated_checkbox = (CheckBox) convertView.findViewById(R.id.addfield_denominated_checkbox);
            holder.maddfield_denominated_edittext = (EditText) convertView.findViewById(R.id.addfield_price_denominated_edittext_left);
            holder.maddfield_denominated_view = (View) convertView.findViewById(R.id.addfield_denominated_view);
            holder.mright_edittext = (EditText) convertView.findViewById(R.id.addfield_price_denominated_edittext_right);
        ...
        Constants.textchangelistener( holder.maddfield_denominated_edittext);
        Constants.textchangelistener( holder.mright_edittext);
        if (mactivity.editorsizetxt) {
            holder.maddfield_denominated_edittext.setText(data.get(position).get("edittext_left").toString());
            holder.mright_edittext.setText(data.get(position).get("edittext_right").toString());
        }
        if (isSelected_addfield_fieldsize.get(position) == 1) {
            ...
            if (position == 0) {
                ...
                mactivity.maddfield_fieldsizelistview.setLayoutParams(layoutParams);
                holder.maddfield_denominated_edittext.setText("");
                holder.mright_edittext.setText("");
                ...
                holder.mright_edittext.setBackgroundColor(mactivity.getResources().getColor(R.color.white));
                ...
                holder.mright_edittext.setBackgroundDrawable(mactivity.getResources().getDrawable(R.drawable.choosespecifications_pricetxtselect));
        ...
        setListener(holder.mright_edittext, holder.mdenominated_checkbox, position);
        //            Constants.disableSubControls(holder.maddfield_denominated_fieldsizelayout); 代理禁止编辑
        return convertView;
    }
    static class ViewHolder {
        ...
        public EditText mright_edittext;
    }
    ...
    public static void setIsSelected_addfield_fieldsize(HashMap<Integer, Integer> isSelected) {
        Addfield_fourlisviewadapter.isSelected_addfield_fieldsize = isSelected;
    }
