package com.linhuiba.linhuifield.fieldcallback;
...
public class Field_MyAllCallBack {
    ...
    public void getAddfieldFourSpecialcall(Field_AddFieldChoosePictureCallBack.AddfieldFourSpecialCall callBack) {
        callBack.getAddfieldFourSpecialcall(position);
    }
