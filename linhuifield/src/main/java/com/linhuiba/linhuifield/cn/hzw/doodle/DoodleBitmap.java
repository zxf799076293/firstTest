...
public class DoodleBitmap extends DoodleRotatableItemBase {
    ...
    public DoodleBitmap(IDoodle doodle, Bitmap bitmap, float size, float x, float y, Context context) {
        super(doodle, -doodle.getDoodleRotation(), x, y,context); // 设置item旋转角度，使其在当前状态下显示为“无旋转”效果
