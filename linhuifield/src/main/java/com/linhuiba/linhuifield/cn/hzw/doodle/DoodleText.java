...
public class DoodleText extends DoodleRotatableItemBase {
    ...
    public DoodleText(IDoodle doodle, String text, float size, IDoodleColor color, float x, float y, Context context) {
        super(doodle, -doodle.getDoodleRotation(), x, y,context);
