...
public class DefaultClusterRenderer<T extends ClusterItem> implements
     ...
     */
    private static final int MIN_CLUSTER_SIZE = 0;//4
    ...
    protected void onBeforeClusterRendered(Cluster<T> cluster, MarkerOptions markerOptions) {
        ...
        if (descriptor == null) {
//            mColoredCircleBackground.getPaint().setColor(getColor(bucket)); //修改聚合背景
            mColoredCircleBackground.getPaint().setColor(Color.argb(185, 65,105,255));
