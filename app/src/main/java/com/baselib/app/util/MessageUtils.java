...
//        mToast.setView(view);
    ...
    public static void showDialog(Context context, String title, String message,int btn_confirm_text,
                                  OnClickListener okListener,
                                  OnClickListener cancelListener) {
        createDialog(context, title, message, btn_confirm_text, okListener, R.string.cancel,
                cancelListener).show();
    }
    public static void showDialog(Context context, String title, String message,int btn_confirm_text,
                                  int btn_cancel_text,
    ...
    public static void showDialog(Context context, Dialog dialog, String title, String message,
                                  OnClickListener okListener,
                                  OnClickListener cancelListener) {
    ...
    public static void showDialog(Context context, String strTitle, String strText,
            OnClickListener listener, boolean showNegative) {
        OnClickListener onNegativeListener = null;
        if (showNegative) {
            onNegativeListener = new OnClickListener() {
                @Override
    ...
    public static AlertDialog createDialog(Context context, String title, String msg,
            int positiveBtnTx, OnClickListener okListener,
            int negativeBtnTxt, OnClickListener cancelListener) {
    ...
    public static void showMapToast(String s) {
        if(mToast==null){
