...
public class CalendarReminderUtils {
    ...
    private static String CALENDARS_NAME = "linhuiba";
    private static String CALENDARS_ACCOUNT_NAME = "linhuiba@test.com";
    private static String CALENDARS_ACCOUNT_TYPE = "com.android.linhuiba";
    private static String CALENDARS_DISPLAY_NAME = "linhuiba";
...
//        mCalendar.setTimeInMillis(start + 2 * 60 * 1000);//设置终止时间，开始时间加10分钟
        ...
        values.put(CalendarContract.Reminders.MINUTES, 1); // 提前1分钟有提醒(提前0分钟时，值为0)
