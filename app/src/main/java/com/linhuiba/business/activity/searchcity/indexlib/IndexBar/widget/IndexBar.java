package com.linhuiba.business.activity.searchcity.indexlib.IndexBar.widget;
...
import com.linhuiba.business.activity.searchcity.indexlib.IndexBar.helper.IIndexBarDataHelper;
import com.linhuiba.business.activity.searchcity.indexlib.IndexBar.helper.IndexBarDataHelperImpl;
...
public class IndexBar extends View {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mPaint.setColor(getResources().getColor(R.color.default_bluebg));
    ...
    public boolean onTouchEvent(MotionEvent event) {
        switch (event.getAction()) {
            ...
            default:
                setBackgroundResource(android.R.color.white);//手指抬起时背景恢复透明
                //回调监听器
