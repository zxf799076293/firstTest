...
public class MeituanHeaderBean extends BaseIndexPinyinBean {
    private List<SearchCityModel> cityList;
    ...
    public MeituanHeaderBean(List<SearchCityModel> cityList, String suspensionTag, String indexBarTag) {
        this.cityList = cityList;
        this.suspensionTag = suspensionTag;
        this.setBaseIndexTag(indexBarTag);
    }

    public List<SearchCityModel> getCityList() {
        return cityList;
    }

    public MeituanHeaderBean setCityList(List<SearchCityModel> cityList) {
        this.cityList = cityList;
        return this;
    }
