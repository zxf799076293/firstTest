package com.linhuiba.business.activity.searchcity.indexlib.suspension;
...
public class SuspensionDecoration extends RecyclerView.ItemDecoration {
    ...
    private static int COLOR_TITLE_BG = 0xffefefef;
    private static int COLOR_TITLE_FONT = R.color.register_edit_color;
    ...
    public void getItemOffsets(Rect outRect, View view, RecyclerView parent, RecyclerView.State state) {
        ...
        if (position > -1) {
            ...
            if (titleCategoryInterface.isShowSuspension()) {
                if (position == 0) {
                    outRect.set(0, mTitleHeight, 0, 0);// 2018/4/9 分割线
                } else {//其他的通过判断
