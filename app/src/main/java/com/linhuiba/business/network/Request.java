...
public class Request {
    ...
    public static okhttp3.Request RequestJsonGet(String baseUrl, String function,
                                             HashMap<String, String> paramsMap, int connector_version) {
        okhttp3.Request request =null;
        String requestUrl = "";
        paramsMap.put("v", BuildConfig.VERSION_NAME);
    ...
    public static String urlEncode(HashMap<String, String> params)
            throws UnsupportedEncodingException {
        StringBuffer sb2 = new StringBuffer();
        for (HashMap.Entry<String, String> entry : params.entrySet()) {
            if (entry.getKey() != null && entry.getValue() != null) {
                if (entry.getKey().indexOf("attributes[") != -1) {//场地列表搜索专用
