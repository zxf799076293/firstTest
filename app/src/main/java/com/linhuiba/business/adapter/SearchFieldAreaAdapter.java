...
public class SearchFieldAreaAdapter extends BaseAdapter {
    ...
    public SearchFieldAreaAdapter(Context context, ArrayList<String> list, int type, int clickedposition) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        AreaListViewAdapter.ViewHolder holder = null;
        if (convertView == null) {
            holder = new AreaListViewAdapter.ViewHolder();
            ...
            holder = (AreaListViewAdapter.ViewHolder) convertView.getTag();
        }
        if (type == 1) {
        ...
        holder.list_name.setText(list.get(position).toString());
